...
After a run, copy the badge from the job summary into your README. Green means a clean static surface. It links back to the method and the ecosystem scoreboard so anyone can see what "low surface" is measured against.
